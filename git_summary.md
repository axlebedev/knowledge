...
_Index_ - так еще называем staging area - те изменения которые попадут в коммит.  
_Working tree_ - физические файлы на диске в текущий момент
...
## Команды
 ...
 - [`git clean`](#git-clean) - удалить файлы
