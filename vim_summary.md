...
|  | в последнюю команду можно в after подавать тег: cs"<p> заменит окружающие на тег
|  | в последнюю команду можно в before подавать `w` или `W`: csw" поместит слово в кавычки
