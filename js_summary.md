...
равны только друг другу (и самим себе). _NaN_ не равен вообще ничему.
...
`unshift()` - push_front, возвращает полученную длину, может принимать несколько аргументов.
...
4. Присваивание сразу нескольких переменных  
  1. Через _let_, дальше как в питоне:

    var arr[1,2];
    let [a, b] = arr; //a = 1, b = 2
  2. Остаток массива выдергиваем через многоточие:

	let [firstName, lastName, ...rest] = "Юлий Цезарь Император Рима".split(" ");
	rest; // ["Император", "Рима"]

  3. Можно ставить дефолтные значения:
	let [firstName="Гость", lastName="Анонимный"] = [];

  4. С объектами такое тоже прокатит:
...
Нюанс:
  ...
  5. Можно вкладывать конструкции друг в друга:
    let options = {
        size: {
            width: 100,
            height: 200
